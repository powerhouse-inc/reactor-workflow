import { PiecePropertyMap } from "./property/index.js";
import { PieceAuthProperty } from "./property/authentication/index.js";
import * as z from "zod/mini";
import { LocalesEnum } from "../../core-utils/index.js";
import { PackageType, PieceCategory, PieceType, TriggerStrategy, TriggerTestStrategy, WebhookHandshakeConfiguration } from "../../piece-types/index.js";
import { ContextVersion } from "./context/versioning.js";
import type { OutputSchema } from "./output-schema.js";

// ph: hoisted from action/action.ts and trigger/trigger.ts (which re-export
// them) to break value import cycles that TDZ-crash the browser bundle.
