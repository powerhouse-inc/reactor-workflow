import { ApId, BaseModelSchema, DateOrString, Nullable } from '../../../../core-utils/index.js'
import { z } from 'zod'
import { FederatedAuthnProviderConfig, FederatedAuthnProviderConfigWithoutSensitiveData } from '../../core/federated-authn/index.js'
import { SsoDomainVerification } from './sso-domain-verification.js'
