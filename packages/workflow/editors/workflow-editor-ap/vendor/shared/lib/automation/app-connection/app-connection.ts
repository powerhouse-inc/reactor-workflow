import { ApId, type BaseModel, BaseModelSchema, Metadata, Nullable } from '../../../../core-utils/index.js'
import { z } from 'zod'
import { UserWithMetaInformation } from '../../core/user/index.js'
import type { OAuth2GrantType } from './dto/upsert-app-connection-request.js'
import { OAuth2AuthorizationMethod } from './oauth2-authorization-method.js'
