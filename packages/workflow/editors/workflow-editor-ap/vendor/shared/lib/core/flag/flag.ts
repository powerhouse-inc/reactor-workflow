import { ApId, type BaseModel } from '../../../../core-utils/index.js'
...
export enum ApFlagId {
    ...
    EMAIL_CODE_AUTH_ENABLED = 'EMAIL_CODE_AUTH_ENABLED',
    ...
    FLOW_RUN_LOG_SIZE_LIMIT_MB = 'FLOW_RUN_LOG_SIZE_LIMIT_MB',
